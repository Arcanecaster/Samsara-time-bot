...
regions = {
'Bachtalan': ['bachtalan', 'bach'],
'Cortashar Dominion': ['cortashar dominion', 'cortashar', 'cd'],
'Dirk': ['dirk', 'drk'],
'Divine Empire of Srath': ['divine empire of srath', 'srath', 'des', 'empire'],
'Farleaf': ['farleaf', 'fl'],
'Farwing Tribes': ['farwing tribes', 'farwing', 'fw'],
'Femursnap Tribes': ['femursnap tribes', 'femursnap', 'ft'],
'Kingdom of Evercia': ['kingdom of evercia', 'evercia', 'ke'],
'Kingdom of Gundahn': ['kingdom of gundahn', 'gundahn', 'kg'],
'Kobold Tribes': ['kobold tribes', 'kobold', 'kt'],
'Lunan': ['lunan', 'lu'],
'Orcish Legions': ['orcish legions', 'orc', 'ol'],
'Meloz Tribe': ['meloz tribe', 'meloz', 'mt'],
'Redhorn Hordes': ['redhorn hordes', 'redhorn', 'rh'],
'Rustvault': ['rustvault', 'rv'],
'Samsara': ['samsara', 'sam'],
'Blue Coast Bay': ['blue coast bay', 'blue coast', 'bcb'],
'Skarlian Holy State': ['skarlian holy state', 'skarlian', 'shs'],
...
'Thrusk': ['thrusk', 'tr'],
'Tiamats Eye': ['tiamats eye', 'tiamat', 'te'],
...
graph = {
    ...
    'Farleaf': {'Sinios': 12, 'Cortashar Dominion': 10, 'Vurn Darul': 10, 'Acerica': float('inf')},
    ...
    'Kingdom of Gundahn': {'Vurn Darul': 7, 'Sinios': 6, 'Venuvia': 5, 'Thornian Council': 4, 'Acerica': float('inf')},
    ...
    'Venuvia': {'Rustvault': 8,'Thornian Council': 5,'Kingdom of Gundahn': 5, 'Acerica': float('inf')},
    'Vurn Darul': {'Farleaf': 10,'Kingdom of Gundahn': 7,'Sinios': 4, 'Acerica': float('inf')},
