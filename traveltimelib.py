...
regions = {
    ...
    'Gondria': ['gondria', 'vurn darul', 'vurn', 'darul', 'gond'],
    ...
    'Millheim Council': ['milhelm', 'milhelm council', 'thornian council', 'thornian', 'mc'],
    ...
    'The Kingdom Of Balimor': ['balimor ', 'bali', 'the kingdom of balimor', 'gundahn', 'tkob'],
...
Timegraph = {
    'Aceria': {'Amberstone': 13, 'The Kingdom Of Balimor': 8, 'Gondria': 4, 'Solana': 7},
    'Albalatin Holy State': {'Solana Tribes': 12, 'Duronia': 10, 'Tiamats Eye': 10, 'Tungsten State': 3, 'Kingdom of Leonia': 1},
    'Amberstone': {'Onyxbridge': 8, 'Millheim Council': 5, 'The Kingdom Of Balimor': 5, 'Aceria': float('inf')},
    ...
    'Etelkoz': {'Duronia': 12, 'Eisenland': 12, 'Solana': 12, 'Everfjord': 11, 'Bihar Hordes': 8, 'Millheim Council': 6, 'Gondria': 4},
    'Everfjord': {'Duronia': 11, 'Etelkoz': 11, 'Millheim Council': 2},
    'Gondria': {'Solana': 10, 'The Kingdom Of Balimor': 7, 'Etelkoz': 4, 'Aceria': float('inf')},
    ...
    'Millheim Council': {'Etelkoz': 6, 'Amberstone': 5, 'The Kingdom Of Balimor': 4, 'Everfjord': 2},
    ...
    'Solana': {'Etelkoz': 12, 'Eisenland': 10, 'Gondria': 10, 'Aceria': float('inf')},
    ...
    'The Kingdom Of Balimor': {'Gondria': 7, 'Etelkoz': 6, 'Amberstone': 5, 'Millheim Council': 4, 'Aceria': float('inf')},
    'Zamwall Tribes': {'Ramchatca': 13, 'Satharia': 7, 'Kemet': 5, 'Duronia': 5, 'Bachtalan': 5, 'Norstraden': 2}
}

Milesgraph = {
    'Aceria': {'Amberstone': 650, 'The Kingdom Of Balimor': 400, 'Gondria': 200, 'Solana': 350},
    'Albalatin Holy State': {'Solana Tribes': 600, 'Duronia': 500, 'Tiamats Eye': 500, 'Tungsten State': 150, 'Kingdom of Leonia': 50},
    'Amberstone': {'Onyxbridge': 400, 'Millheim Council': 250, 'The Kingdom Of Balimor': 250, 'Aceria': float('inf')},
    ...
    'Etelkoz': {'Duronia': 600, 'Eisenland': 600, 'Solana': 600, 'Everfjord': 550, 'Bihar Hordes': 400, 'Millheim Council': 300, 'Gondria': 200},
    'Everfjord': {'Duronia': 550, 'Etelkoz': 550, 'Millheim Council': 250},
    'Gondria': {'Solana': 500, 'The Kingdom Of Balimor': 350, 'Etelkoz': 200, 'Aceria': float('inf')},
    ...
    'Millheim Council': {'Etelkoz': 300, 'Amberstone': 250, 'The Kingdom Of Balimor': 200, 'Everfjord': 250},
    ...
    'Solana': {'Etelkoz': 600, 'Eisenland': 500, 'Gondria': 500, 'Aceria': float('inf')},
    ...
    'The Kingdom Of Balimor': {'Gondria': 350, 'Etelkoz': 300, 'Amberstone': 250, 'Millheim Council': 200, 'Aceria': float('inf')},
